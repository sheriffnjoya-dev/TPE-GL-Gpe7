...
<head>
    <meta charset="UTF-8">
    <title>Title</title>
    <link rel="stylesheet" type="text/css" href="../Assets/css/semestre.css" >
</head>
<body>
            ...
            <div class="nav">
                <div class="ajouter">
                    <form action="tab_semestre.php" method="post">
                        ...
                        <label class="form" id="form-label3">SEMESTRE :</label>
                        <select class="form" id=form-control3 name="choix_semestre">
                            <option>SEMESTRE I</option>
                            <option>SEMESTRE II</option>
                        </select>
                        <label class="form-label" id="form-label">MATRICULE :</label>
                        <input class="form_label" id="form-control" type="text" name="matricule" placeholder="Entrez votre matricule" required>
                        <input class="input" id="bouton" type="submit" name="btnSemestre" value="SAVE">
                    </form>
                </div>
            </div>
        </div>
